!(function(e, o) {
    ...
    return (function() {
            ...
            n = (function() {
                ...
                return (
                    o(n, [{
                            ...
                            value: function() {
                                for (
                                    var e = this, o = arguments.length, t = Array(o), i = 0; i < o; i++
                                )
                                    t[i] = arguments[i];
        ...
        return {
            init: function(e) {
                var o = Object.assign({}, { openTrigger: "data-micromodal-trigger" },
                        e
                    ),
                    i = [].concat(
...
var button = document.querySelector(".card-1");
button.addEventListener("click", function() {
    MicroModal.show("modal-1");
});

var button = document.querySelector(".card-2");
button.addEventListener("click", function() {
    MicroModal.show("modal-2");
});

var button = document.querySelector(".card-3");
button.addEventListener("click", function() {
